...
class WorkflowEngine {
  constructor(workflow, event, { globalData, tabId = null, isInCollection, collectionLogId }) {
  ...
  _blockHandler(block, prevBlockData) {
    ...
    const blockHandler = blocksHandler[camelCase(block?.name)]
    const handler = !blockHandler && tasks[block.name].category === 'interaction' ? blocksHandler.interactionHandler : blockHandler
